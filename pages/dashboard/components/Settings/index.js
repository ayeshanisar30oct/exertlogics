...
const handleInputChange = (e) => {
 ...
 const handleUpdate = (e, linkIdx = null) => {
   ...
   const [field, index] = name.split("_").slice(-2); // Get the field and index from the name attribute

   setEditedData((prevState) => {
     const updatedLinks = [...prevState.header.links];
  ...
  return (
    <>
      <div className="mx-auto">
        ...
        <h2 className="text-title-md2 pb-5 font-semibold text-black dark:text-white">
          Logos
        </h2>
        ...
        <h2 className="text-title-md2 pt-15 pb-8 font-semibold text-black dark:text-white">
          Header Menu
        </h2>
                        ...
                        >
                          {isEditing && editedData.id === nav.id ? (
                            <input
                              ...
                              value={
                                editedData.header.links[linkIdx]?.title || ""
                              }
                        ...
                        >
                          {isEditing && editedData.id === nav.id ? (
                            <input
                              ...
                              value={
                                editedData.header.links[linkIdx]?.url || ""
                              }
                              onChange={(e) => handleUpdate(e, linkIdx)}
                            />
                          ) : (
